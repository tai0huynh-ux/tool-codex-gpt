...
P18-PILOT-001 implementation checkpoint - Add typed desktop orchestration, shared pilot contracts, Live Project Pilot UI, static website verifier, and sandboxed preview boundary. Published as `13ddbd4`; live ChatGPT/Codex execution and restart acceptance remain open.
...
1. Add fixture `test:project-pilot`, packaged smoke coverage, and restart-recovery evidence.
...
`pnpm.cmd run verify` passed locally on 2026-07-19 with migration parity, formatting, lint, strict type-check, 190 Vitest tests, two recoverable workflow fixture E2E tests, two Chromium fixture E2E tests, and all 15 buildable workspace projects. No live ChatGPT submit, live structured response, writable Codex run, or website generated by Codex has been claimed in this checkpoint.
